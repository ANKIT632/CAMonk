...
function ResultPage() {
    const { isAnswerCorrect, quizData } = useSelector((state: { quiz: { isAnswerCorrect: boolean[]; quizData: { question: string; correctAnswer: string[] }[] } }) => state.quiz); // Access Redux state
